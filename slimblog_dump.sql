...
CREATE TABLE IF NOT EXISTS `articles` (
  ...
  CONSTRAINT `FK_articles_categories` FOREIGN KEY (`categories_id`) REFERENCES `categories` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8;

-- Дамп данных таблицы slimblog.articles: ~4 rows (приблизительно)
/*!40000 ALTER TABLE `articles` DISABLE KEYS */;
INSERT INTO `articles` (`id`, `title`, `text`, `categories_id`) VALUES
...
-- Дамп данных таблицы slimblog.categories: ~4 rows (приблизительно)
